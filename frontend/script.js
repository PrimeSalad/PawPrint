        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div class="lg:col-span-7 flex flex-col gap-6">
            <div class="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-2xl flex-1 flex flex-col border border-gray-100">
              <div class="mb-6">
                <div class="inline-block px-3 py-1 bg-[#e26215]/10 text-[#e26215] rounded-lg text-[10px] font-black tracking-widest uppercase mb-4">Canine Identification Profile</div>
              ...
              <div class="grid grid-cols-2 gap-4 mb-8">
                <div class="bg-[#fef9f6] p-4 rounded-2xl border border-[#e26215]/5">
                  <span class="text-[9px] font-black text-[#e26215] uppercase tracking-widest block mb-1">Origin</span>
                  <span class="text-[#2d1810] font-bold text-xs">${desc.origin || "Not listed"}</span>
                </div>
                <div class="bg-[#fef9f6] p-4 rounded-2xl border border-[#e26215]/5">
                  <span class="text-[9px] font-black text-[#e26215] uppercase tracking-widest block mb-1">Scale</span>
                  <span class="text-[#2d1810] font-bold text-xs">${desc.size || "Standard"}</span>
                </div>
                <div class="col-span-2 bg-[#1a0f08] p-4 rounded-2xl">
                  <span class="text-[9px] font-black text-[#e26215] uppercase tracking-widest block mb-1">Temperament Architecture</span>
                  <span class="text-white/90 font-medium text-xs">${desc.temperament || "Alert and active"}</span>
                </div>
              </div>
            ...
            <div class="bg-[#f15a24] text-white p-6 rounded-[2rem] shadow-lg flex items-center gap-6">
              ...
              <div>
                <h4 class="text-[10px] font-black uppercase tracking-widest mb-1 opacity-80">Health Protocol</h4>
                <p class="text-xs font-medium leading-relaxed">${desc.health_notes || "Maintain regular veterinary diagnostics for optimal breed longevity."}</p>
              </div>
            </div>
          </div>
